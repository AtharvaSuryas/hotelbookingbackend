...
export const register = async(req,res)=>{
    ...
    try{
        ...
        const text = `Welcome to CodeMate. Your account has been created with email id:${email}`;
        await sendemail({email,subject,text});
        const mailOption ={
            from: process.env.SENDER_EMAIL,
            to: email,
            subject:`Welcome to CodeMate. Your account has been created with email id:${email}`
        }
...
export const sendVerifyOtp = async(req,res)=>{
    try{
        ...
        const sendemail = {
            ...
            text: `Welcome to CODEMATE. Your OTP is ${otp}. Verify you account using this OTP`
        }
